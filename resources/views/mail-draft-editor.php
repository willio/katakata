...
<body class="editor-page mail-draft-editor">
<p class="editor-status" data-save-status role="status" aria-live="polite"></p>
<main class="editor-writing mail-draft-editor-frame">
    <form
        method="post"
    ...
    >
        ...
        <section class="mail-compose-paper" aria-label="Correspondence draft">
            <div class="mail-compose-field">
                ...
                <input id="mail-to" name="to" type="email" required value="<?= e($draft->to) ?>" autocomplete="email">
            </div>
            <div class="mail-compose-field">
            ...
            <div class="mail-compose-body">
                ...
                <textarea id="mail-text" name="text" required autofocus><?= e($draft->text) ?></textarea>
            </div>
        </section>
