...
<main class="editor-writing mail-draft-editor-writing">
    ...
    <?php if (!$draft->isConfirmed()): ?>
        <form
            id="campaign-draft-form"
            class="mail-draft-editor-form"
            method="post"
            action="/mail/campaign-drafts/<?= e($draft->id) ?>"
            data-autosave-url="/mail/campaign-drafts/<?= e($draft->id) ?>/autosave"
        ...
        >
            ...
            <div class="mail-compose-paper campaign-compose-paper">
                <div class="mail-compose-field campaign-compose-field">
